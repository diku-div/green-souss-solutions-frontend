  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-10 text-gray-800">
      ...
      <section className="flex flex-col gap-5 scroll-mt-24" id="Dammage">
        ...
        <p className="text-lg text-black/50 font-extralight">
          That&rsquo;s why we&rsquo;re committed to removing tires from nature and giving them a second life through responsible collection, recycling, and recovery. Every tire we reclaim helps protect our environment and move us one step closer to a cleaner, healthier Africa.
        </p>
        <div className="mt-4">
      ...
      <section className="flex flex-col gap-5 scroll-mt-24" id="Collection">
        ...
        <p className="text-lg text-black/50 font-extralight">
          Our process starts with the efficient and environmentally responsible collection of used tires. We&rsquo;ve developed a network that connects with:
        </p>
        ...
        <p className="text-lg text-black/50 font-extralight">
          By offering incentives and building partnerships, we&rsquo;ve made it easier for businesses and local governments to participate in responsible tire disposal. Every tire we collect is one step closer to a cleaner and healthier environment.
        </p>
        <div className="mt-4">
      ...
      <section className="flex flex-col gap-5 scroll-mt-24" id="Recovery">
        ...
        <p className="text-lg text-black/50 font-extralight">
          Recycling isn&rsquo;t the only option—we also offer innovative tire recovery services that extend the lifecycle of used tires and reduce overall waste.
        </p>
      ...
      <section className="flex flex-col gap-5 scroll-mt-24" id="Friendly">
        ...
        <p className="text-lg text-black/50 font-extralight">
          By offering local businesses access to high-quality, eco-friendly raw materials, we support the growth of green industries and help reduce Africa&rsquo;s reliance on imported goods.
        </p>
        <div className="mt-4">
